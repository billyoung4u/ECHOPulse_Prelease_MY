    ...
    def forward(
        ...
        *,
        ...
        if exists(video_frame_mask):
            ...
            # video_mask = self.cvivit.calculate_video_token_mask_firstframe(
            #     videos,
            #     video_frame_mask = video_frame_mask
            # )
        ...
        if not exists(video_mask):
            ...
            # video_mask[:, :256] = False  ## to-dos
        # print(video_mask.size())
        # print(video_mask)
        # video_mask = torch.ones((32, 1536), device=device).bool()
        
        # 将每个样本的前256个数据设置为False
